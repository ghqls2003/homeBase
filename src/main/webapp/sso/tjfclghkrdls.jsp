...
<table>
	<thead>
		<tr>
			<td width="20%" colspan="2">Agent Test</td>
		</tr>
	</thead>
	<tbody>
	<!-- java version -->
...
<%
try{
	out.print(this.getServletConfig().getServletContext().getRealPath("."));
}catch(Exception e){
...
<%
try{
	out.print(System.getProperty("dreamsecurity.home.path"));
}catch(Exception e){
	out.print(e.toString());
}
%>		
	...
	<tr>
		...
		<input type="radio" name="type" value="IDP">IDP
		<br/>
		<input type="button"  id="loadingTestBt" name="loadingTestBt" value="class loading test" onclick="loadingTest();return false;"  />
		</td>
		<td>
			<div id="dumcon"></div>
			<iframe name="ifSrv1" id="ifSrv1" src=""  scrolling="yes" frameborder="no" width="800" height="250"></iframe>
			<iframe name="ifSrv2" id="ifSrv2" src=""  scrolling="yes" frameborder="no" width="800" height="500"></iframe>
		</td>
    </tr>
	</tbody>
</table>
...
<form name="frmClasschk" id="frmClasschk" method="post" action="">
