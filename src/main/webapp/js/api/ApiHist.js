...
(function(W, D, $) {
	...
	$apiHist.ui = {
		...
		pageLoad: function() {
			...
			//			$('button.k-input-button.k-button.k-button-md.k-button-solid.k-button-solid-base.k-icon-button:eq(1),button.k-input-button.k-button.k-button-md.k-button-solid.k-button-solid-base.k-icon-button:eq(2)').removeClass("k-input-button");
