(function (W, D, $) {
	...
	var pcColumns = [
		{title: "순번", field: "rn", template: "#: rn #", width: 100},
		...
		{title: "대여상태", field: "rentSttsNm", template: "#: rentSttsNm #", width: 100},
		{field: "대여 확인증", exportable: false, template: "<button class='gray_btn' style='width: 70px;height: 30px;' onclick='javascript:$rentalHistManage.event.issued(`#:rentNo#`, `#:rentSttsNm#`);'>발급</button>", width: 100}
	];

	var mobiColumns = [
		{title: "순번", field: "rn", width: "60px", template: "#: rn #", width: 100},
		...
		{title: "대여상태", field: "rentSttsNm", width: "80px", template: "#: rentSttsNm #", width: 100},
		{field: "대여 확인증", width: "90px", exportable: false, template: "<button class='gray_btn' style='width: 70px;height: 30px;' onclick='javascript:$rentalHistManage.event.issued(`#:rentNo#`, `#:rentSttsNm#`);'>발급</button>", width: 100}
	];
		...
		kendoGrid : function() {
			$("#rentalHistGrid").kendoGrid({
				...
				excelExport: async function(e) {
					...
					var a_data = e.data;
					var accUrl = "/vfc/rentalHistManage/excelDown";
