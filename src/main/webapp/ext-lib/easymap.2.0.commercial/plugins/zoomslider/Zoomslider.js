    ...
    L.Control.Zoomslider = (function () {
        ...
        var Zoomslider = L.Control.extend({
            ...
            _createUI: function () {
                ...
                ui.bar     = L.DomUtil.create('div', ns + ' L-bar');
                ui.zoomIn  = this._createZoomBtn('in', 'top', ui.bar);
                ui.wrap    = L.DomUtil.create('div', ns + '-wrap L-bar-part', ui.bar);
            ...
            _initEvents: function () {
                ...
                /*시도, 시군구, 읍면동 ui*/
                $(".L-control-zoomslider").append("<div class='zoom-label-area'><dl class='label label-1'>읍면동</dl><dl class='label label-2'>시군구</dl><dl class='label label-3'>시도</dl><dl class='label label-4'>국가</dl></div>");
