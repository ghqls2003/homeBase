...
(function () {
  d3.timeline = function() {
    ...
    function timeline (gParent) {
      ...
      // 시, 종점의 틱을 없애기 위해 하드코딩함. (2022-04-29 정금담)
      xAxis.outerTickSize([0]);
      
      // 시, 종점 시간을 표시하기 위해 하드코딩함. 옵션을 넘겨받는 방법으로 바꿀 것. (2022-04-21 정금담)
      // xAxis.tickValues(xScale.ticks(xAxis.ticks()[0]).concat(xScale.domain()));
      
      // 시, 종점 시간을 표시하기 위해 일단 주석함 (2022-04-21 정금담)
      // axis 객체의 ticks() 메소드 동작 원리 찾아볼 것
