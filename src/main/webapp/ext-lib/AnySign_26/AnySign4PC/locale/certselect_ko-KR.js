(function() { 
	...
	pfx_guide: "인증서 파일은 한개(*.pfx, *.p12) 또는 묶음",
	...
	cert_view_not_support: "인증서 상세보기가 지원되지 않는 인증서입니다.",
	cert_sync_msg: "클라우드 서비스와 동기화 되어있습니다.",
	verifypasserr: "인증서 암호가 올바르지 않습니다.\r\n인증서 암호는 대문자 소문자를 구분합니다.\r\n<Caps Lock>키가 켜져 있는지 확인하시고 다시 입력하십시오.",
	copy_not_support: "인증서 복사 기능이 지원되지 않는 매체입니다.",
	BrowserCert_notSupported: "브라우저 인증서는 해당 기능을 지원하지 않습니다.",

	/* fincert */
	fincert_begin: "금융결제원 금융인증서 인증을 시작합니다.",
	fincert_block_popup: "팝업 차단시, 팝업 허용 후 다시 시도해 주세요.",
	fincert_content: "내용들어갑니다. 상세한 내용이 들어갈 예정입니다.",
	fincert_cs: "이용방법 문의 : 1577-5500",
	fincert_request_auth: "인증요청하기",
	fincert_plain: "원문",
