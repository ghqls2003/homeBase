(function() { 
    return {
	hsm_select: "보안 토큰 서비스 제공자 선택",
	media_hdd: "하드 디스크",
	media_mobile: "휴대폰",
	media_pkcs11: "보안 토큰",
	media_removable: "이동식 디스크",
	media_savetoken: "저장 토큰",

	table_expire: "만료일",
	table_issuer: "발급자",
	table_section: "보안 토큰 서비스 모듈",
	table_user: "사용자",
	...
	selectNotify: "보안 토큰 서비스 모듈을 선택하십시오.",
	tokenNotify: "보안 토큰(USB/IC카드 등)이 정상적으로 꽂혀 있는지 확인하십시오.",
	token_error: "보안 토큰 실행 중 오류가 발생하였습니다.",
	token_cancel: "보안 토큰 실행이 취소되었습니다.",
