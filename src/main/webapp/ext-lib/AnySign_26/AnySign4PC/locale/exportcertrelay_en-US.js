(function() {  
	...
	cert_view_not_support: "Certificate details view is not supported.",
	cert_sync_msg: "It is synchronized with the cloud service.",
	verifypasserr: "The password is incorrect. Make sure that <Caps Loc> is off and re-enter your password.",
	copy_not_support: "Certificate copy function is not supported.",
	BrowserCert_notSupported: "Browser Cert is not supported",
	code_text: "Auth Code",
	code_1: "First 4 digit auth code",
	code_2: "Second 4 digit auth code",
	code_3: "Third 4 digit auth code",
	step_1: "1. Select the certificate to export and enter a password.",
	step_2: "2. Enter the auth code created on the screen.",
	info_1: "[1] In the browser where you want to move the certificate, perform a 'import certificate'.",
	info_2: "[2] Enter the auth code displayed on the screen and complete the import.",
	info_title: "How to use auth code",
