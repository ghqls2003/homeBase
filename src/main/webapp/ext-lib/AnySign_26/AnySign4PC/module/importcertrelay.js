var __importcertrelay = function(__SANDBOX) {
...
XWC.getLocaleResource("importcertrelay", XWC.lang());

function onload(aDialogObj) {
	gDialogObj = aDialogObj;
	gErrCallback = gDialogObj.args.errCallback || gErrCallback_common;

	XWC.Event.add(__12, "keyup", function(e) {
		__12.value = __12.value.replace(/[^0-9]/g,"");

		if (__12.value.length == 4)
			__13.focus();
	});
	XWC.Event.add(__13, "keyup", function(e) {
		__13.value = __13.value.replace(/[^0-9]/g,"");

		if (__13.value.length == 4)
			__14.focus();
	});
	XWC.Event.add(__14, "keyup", function(e) {
		__14.value = __14.value.replace(/[^0-9]/g,"");
	});
	...
	if (AnySign.mEnableAuthCodeForImportCertRelay == true)
	{
		...
		_cb_registerAuthCodeForImportCertRelay = function (aResult) {
			...
			if (aResult != 0)
			{
				...
				__SANDBOX.isFailed(aResult, gErrCallback);
			}
			else
			{
				__12.value = aAuthCode[0];
				__13.value = aAuthCode[1];
				__14.value = aAuthCode[2];
			}
		...
		__SANDBOX.upInterface().registerAuthCodeForImportCertRelay(AnySign.mCertRelayFromBrowserServerUrl,
...
function onOKButtonClick(e) {
	...
	if (aCode_1.length == 0 ||
		aCode_2.length == 0 ||
		aCode_3.length == 0) {
		alert(XWC.S.blank_text);
		setOKButtonDisabled(false);
		return;
	}

	showGuideDialog();
	_cb_importCertRelayToBrowser = function (aResult) {
		gGuideDialog.dispose();

		if (aResult == 0)
			alert(XWC.S.import_success);
		else
			__SANDBOX.isFailed(aResult, gErrCallback);
	...
	__SANDBOX.upInterface().importCertRelayToBrowser(AnySign.mCertRelayFromBrowserServerUrl,
													 aCode_1 + aCode_2 + aCode_3,
													 AnySign.mWithCredentialsForCORS,
...
function showGuideDialog (aCallback) {
...
__7.className = 'xwup-code-field';
var __8 = XWC.UI.createElement('UL');
var __9 = XWC.UI.createElement('LI');
var __10 = XWC.UI.createElement('DIV');
__10.className = 'xwup-import-codefield-content';
__10.appendChild(document.createTextNode(XWC.S.code_text));
__9.appendChild(__10);
var __11 = XWC.UI.createElement('DIV');
var __12 = XWC.UI.createElement('INPUT');
__12.setAttribute('id', 'xwup_code_1', 0);
__12.setAttribute('tabindex', '3', 0);
__12.setAttribute('type', 'text', 0);
__12.className = 'xwup-code-box';
__12.setAttribute('title', XWC.S.code_1, 0);
__12.setAttribute('maxlength', '4', 0);
__11.appendChild(__12);
__11.appendChild(document.createTextNode('-'));
var __13 = XWC.UI.createElement('INPUT');
__13.setAttribute('id', 'xwup_code_2', 0);
__13.setAttribute('tabindex', '3', 0);
__13.setAttribute('type', 'text', 0);
__13.className = 'xwup-code-box';
__13.setAttribute('title', XWC.S.code_2, 0);
__13.setAttribute('maxlength', '4', 0);
__11.appendChild(__13);
__11.appendChild(document.createTextNode('-'));
var __14 = XWC.UI.createElement('INPUT');
__14.setAttribute('id', 'xwup_code_3', 0);
__14.setAttribute('tabindex', '3', 0);
__14.setAttribute('type', 'text', 0);
__14.className = 'xwup-code-box';
__14.setAttribute('title', XWC.S.code_3, 0);
__14.setAttribute('maxlength', '4', 0);
...
__15.className = 'blank10_relay';
__15.appendChild(document.createTextNode(XWC.S.step_2));
__5.appendChild(__15);
var __16 = XWC.UI.createElement('DIV');
__16.className = 'xwup-radio-field';
var __17 = XWC.UI.createElement('INPUT');
__17.setAttribute('type', 'radio', 0);
__17.setAttribute('id', 'xwup_importcertrelay_localstorage', 0);
__17.setAttribute('tabindex', '3', 0);
__17.setAttribute('title', XWC.S.media_localstorage, 0);
__17.style.width = '18px';
__17.style.height = '18px';
__17.setAttribute('checked', '', 0);
__17.setAttribute('disabled', 'disabled', 0);
__16.appendChild(__17);
var __18 = XWC.UI.createElement('LABEL');
__18.htmlFor = 'xwup_importcertrelay_localstorage';
__18.appendChild(document.createTextNode(XWC.S.media_localstorage));
__16.appendChild(__18);
__5.appendChild(__16);
var __19 = XWC.UI.createElement('DIV');
__19.className = 'xwup-buttons-layout';
var __20 = XWC.UI.createElement('BUTTON');
__20.setAttribute('type', 'button', 0);
__20.setAttribute('tabindex', '3', 0);
__20.setAttribute('id', 'xwup_OkButton', 0);
__20.onclick = function(event) {onOKButtonClick(event)};
__20.appendChild(document.createTextNode(XWC.S.button_ok));
__19.appendChild(__20);
var __21 = XWC.UI.createElement('BUTTON');
__21.setAttribute('type', 'button', 0);
__21.setAttribute('tabindex', '3', 0);
__21.setAttribute('id', 'xwup_CancelButton', 0);
__21.onclick = function(event) {onCancelButtonClick(event)};
__21.appendChild(document.createTextNode(XWC.S.button_cancel));
