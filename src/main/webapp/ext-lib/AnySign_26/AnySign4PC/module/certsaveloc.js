...
function onload(aDialogObj) {
	...
	if (gDialogObj.args.extValues) 
	{
		var aIsBrowserCert = aDialogObj.args.extValues[0];
		var aCertSource = aDialogObj.args.extValues[1];

		if (aIsBrowserCert)
		{
						gRadioButtons[0].disabled = true;
			gRadioButtons[1].disabled = true;
			gRadioButtons[2].disabled = true;
			gRadioButtons[3].disabled = true;
			gRadioButtons[4].disabled = true;
			gRadioButtons[5].disabled = true;
			gRadioButtons[6].disabled = true;
			gRadioButtons[7].disabled = true;
			gRadioButtons[8].disabled = false;
			gRadioButtons[9].disabled = true;

			gRadioButtons[0].checked = false;
