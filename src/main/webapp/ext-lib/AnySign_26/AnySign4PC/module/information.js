var __information = function(__SANDBOX) {
...
XWC.getLocaleResource("information", XWC.lang());

function onload(aDialogObj) {
	gDialogObj = aDialogObj;

	__5.onclick = function() { 
		AnySign.mShowInfoDialog.close = true;
		onCancelButtonClick(); 
	};

	XWC.Event.add(__5, "keyup", onkeyupClose, this);

	XWC.UI.setDragAndDropImg(__2);

	__9.href = AnySign.mHConvert2pfxDownloadURL;

	XWC.Event.add(__11, "keyup", onkeyupLink, this);

	__11.setAttribute('title', XWC.S.open_new_window);

	if (AnySign.mShowInfoDialog.link_type == "href")
	{
		__11.setAttribute('href', AnySign.mShowInfoDialog.link);
		__11.setAttribute('target', AnySign.mShowInfoDialog.target);
	}
	else if (AnySign.mShowInfoDialog.link_type == "window.open")
	{
		__11.onclick = function ()
		{
			window.open (AnySign.mShowInfoDialog.link,
						 AnySign.mShowInfoDialog.name,
						 AnySign.mShowInfoDialog.option);
		}

	}
	else if (AnySign.mShowInfoDialog.link_type == "download") {
		document.location = AnySign.mShowInfoDialog.link;	
	}
...
XWC.UI.appendTabControl = function (aElement) {
	var i,
		aTabableElements = [],
		aChildNodeList = aElement.getElementsByTagName('*'),
		aNode,
	...
	function _reverseFocusElement(e, aStartElementIndex) {
		...
		if (e.shiftKey) {
			if((aCheckReverse < 0) && (aStartElementIndex != 0))
			{
				if(aCurrentElementIndex < aTabableElements.length - 1)
					++aCurrentElementIndex;
	...
	function _keyupHandler (e) {
		...
		if(bParentsTabControl == true)
		{

			var aResultRevers = aOldKeyupEventListner(e);

			if(aResultRevers == true)
			{
				bParentsTabControl = false;
				aCurrentElementIndex = 0;
			}
			else
				return;
		...
		if (aKeyCode == 9) {
			...
			if(_reverseFocusElement(e, aStartElementIndex) == true)
			{
				bParentsTabControl = true;
				aOldKeyupEventListner(e);
			}
...
__1.style.height = '572px';
var __2 = XWC.UI.createElement('DIV');
__2.setAttribute('tabindex', '3', 0);
__2.setAttribute('id', 'xwup_title_information', 0);
__2.className = 'xwup-title';
__2.style.height = '0';
__1.appendChild(__2);
var __3 = XWC.UI.createElement('DIV');
__3.setAttribute('id', 'xwup_body', 0);
__3.className = 'xwup-body';
__3.style.margin = '0';
__3.style.padding = '0';
var __4 = XWC.UI.createElement('IMG');
__4.setAttribute('src', AnySign.mBasePath+'/img/info.jpg', 0);
__4.setAttribute('alt', XWC.S.alt1, 0);
__3.appendChild(__4);
var __5 = XWC.UI.createElement('IMG');
__5.setAttribute('tabindex', '3', 0);
__5.setAttribute('src', AnySign.mBasePath+'/img/btn_pop_close.png', 0);
__5.setAttribute('id', 'xwup_close', 0);
__5.className = 'xwup-information-close';
__5.setAttribute('alt', XWC.S.close, 0);
__3.appendChild(__5);
var __6 = XWC.UI.createElement('DIV');
__6.className = 'xwup-information-box';
var __7 = XWC.UI.createElement('IMG');
__7.setAttribute('src', AnySign.mBasePath+'/img/download.png', 0);
__7.style.marginRight = '2px';
__7.style.verticalAlign = 'bottom';
__7.setAttribute('alt', XWC.S.download, 0);
__6.appendChild(__7);
__6.appendChild(document.createTextNode(XWC.S.info3));
var __8 = XWC.UI.createElement('BR');
__6.appendChild(__8);
__6.appendChild(document.createTextNode(XWC.S.info4));
var __9 = XWC.UI.createElement('A');
__9.setAttribute('tabindex', '3', 0);
__9.className = 'xwup-information-link';
__9.appendChild(document.createTextNode(XWC.S.download));
__6.appendChild(__9);
var __10 = XWC.UI.createElement('DIV');
__10.setAttribute('id', 'xwup_div_space', 0);
__10.className = 'xwup-information-space';
__6.appendChild(__10);
__6.appendChild(document.createTextNode(XWC.S.info1));
var __11 = XWC.UI.createElement('A');
__11.setAttribute('tabindex', '3', 0);
__11.setAttribute('id', 'xwup_info_link', 0);
__11.className = 'xwup-information-link';
__11.setAttribute('title', XWC.S.open_new_window, 0);
__11.appendChild(document.createTextNode(XWC.S.detail));
__6.appendChild(__11);
__6.appendChild(document.createTextNode(XWC.S.info2));
__3.appendChild(__6);
__1.appendChild(__3);
__1.onload = onload;
