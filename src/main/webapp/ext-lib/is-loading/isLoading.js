(function (global, factory) {
    ...
    var IsLoading = function () {
        ...
        _createClass(IsLoading, [{
            ...
            key: '_onElementOverlayType',
            value: function _onElementOverlayType() {
                this._toggleElements(false);
            ...
            key: '_onFullOverlayType',
            value: function _onFullOverlayType() {
                this._toggleElements(false);
                this._showFullOverlay();
            }
        }, {
            key: '_showFullOverlay',
            value: function _showFullOverlay() {
            ...
            key: '_prop',
            value: function _prop(prop) {
                return window.getComputedStyle(this._target).getPropertyValue(prop);
            }
        }, {
            key: '_toggleElements',
            value: function _toggleElements() {
                var status = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;

                var list = [].concat(_toConsumableArray(this._options.disableList));
            ...
            value: function remove() {
                ...
                if (this._options.type === 'overlay' && document.querySelector('.is-loading-element-overlay') != null) {
                    this._target.removeChild(document.querySelector('.is-loading-element-overlay'));
                }
                ...
                if (this._target && this._target.getAttribute('data-is-loading-position')) {
                    this._target.removeAttribute('data-is-loading-position');
