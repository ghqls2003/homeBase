			                ...
			                <div class="mo_flex">
			                    ...
			                    <ul class="selec_box">
			                        <li class="li_slec">
			                            ...
			                            <input type="text" id="prcsSttsYn" class="sendType" aria-label="조치여부" placeholder="조치여부">
			                        </li>
			                    </ul>
			                </div>
								          	...
								          	<tr>
								                ...
								                <td>
								                	<div  class="tb_flex admin">
								                        ...
								                        <input type="text" id="actnPrcsSttsCd" class="input clear" aria-label="처리상태코드" />
								                    </div>
								                </td>
								            </tr>
								         	<tr>
								                ...
								                <td>
								                	<div  class="tb_flex admin">
								                        ...
								                        <input type="text" id="actnDefectsCn" class="input clear" aria-label="결함내용" />
								                    </div>
								                </td>
								            </tr>
								        </table>
								            ...
								            <tr>
								                ...
								                <td>
								                	<div  class="tb_flex admin">
								                        ...
								                        <input type="text" id="actnDefectsTypeCd" class="input clear" aria-label="결함유형코드" />
								                    </div>
								                </td>
								            </tr>
								            <tr>
								    ...
								    <div class="cont cont-flex">
								    	<table class="tb rental_tb01">
								    		<tr>
								    			...
								    			<td>
								    				...
								    				<input type="text" id="detailActnSn" class="input" aria-label="시정조치 일련번호" />
							    					</div>
							    				</td>
							    			</tr>
							    			<tr>
								    			...
								    			<td>
								    				...
								    				<input type="text" id="detailActnVin" class="input" aria-label="차대번호"/>
							    					</div>
							    				</td>
							    			</tr>
							    			<tr>
								    			...
								    			<td>
								    				...
								    				<input type="text" id="detailActnCarRegNo"  class="input" aria-label="차량번호" />
							    					</div>
							    				</td>
							    			</tr>
							    			<tr>
							    			...
							    			<tr>
								    			...
								    			<td>
								    				...
								    				<input type="text" id="detailActnDt"  class="" aria-label="시정조치일"/>
							    					</div>
							    				</td>
							    			</tr>
							    			<tr>
								    	...
								    	<table class="tb rental_tb01">
								    		 <tr>
								                ...
								                <td>
								                    <div class="tb_flex">
								                        <label for="detailActnTyCd">시정조치 유형코드</label>
								                        <input type="text" id="detailActnTyCd" class="input" maxLength="200" />
								                    </div>
								                </td>
								            </tr>
								           <tr>
								                ...
								                <td>
								                    <div class="tb_flex">
								                        <label for="detailActnRsCd">시정조치 결과코드</label>
								                        <input type="text" id="detailActnRsCd" class="input" maxLength="200" aria-label="시정조치 결과코드" />
								                    </div>
								                </td>
								            </tr>
								    		<tr>
								    			...
								    			<td>
								    				...
								    				<input type="text" id="detailActnDefectSn"  class="input " aria-label="결함일련번호" />
							    					</div>
							    				</td>
							    			</tr>
							    			<tr>
								           	...
								           	<tr>
								                ...
								                <td>
								                    <div class="tb_flex">
								                        ...
								                        <input type="text" id="detailActnYn"  class="input clear" maxLength="200" aria-label="조치여부"  />
								                    </div>
								                </td>
								            </tr>
								    	</table>
