...
.authority_02 .cont_txt2 .txt {
    line-height: 26px;
}
.authority_02 .cont_txt2 .txt p {
    line-height: 24px;
}
...
<div class="subPage authority_02" style="display: none">
	<div id="container" class="step1">
		<div class="wrap">
			...
			<div class="contBox">
				<div class="nameBox2">
					<h4 class="name">&lt운전자격확인시스템 업무를 위한 개인정보 수집·이용 및 제공 동의서&gt</h4>
				</div>
				<div class="cont2">
					<div class="cont_txt2">
						<div class="txt">
							<p>한국교통안전공단은 「개인정보 보호법」 등 관련 법령상의 개인정보 보호 규정을 준수하며 개인정보 보호에 최선을 다하고 있습니다. 한국교통안전공단은 다음과 같이 
							운전자격확인시스템의 업무 처리를 위해 개인정보를 수집·이용 및 제공하는데 동의를 받고자 합니다.
							</p>
						</div>
					</div>
				</div>
			...
			<div class="contBox lastBox">
				<div class="nameBox">
					<h4 class="name">개인정보 수집 및 이용 동의(필수)</h4>
				</div>
				<div class="cont">
					<div class="cont_txt">
						<div class="txt" id="txtForuser">
							<p>한국교통안전공단은 운전자격확인에 필요한 개인정보를 수집합니다.</p>
							...
							<p class="dlntxt">사용자 관리 및 권한관리</p>
							<br />
							<h3>* 개인정보 수집 항목</h3>
						    <p class="dlntxt">
						        담당자 이름, 핸드폰, IP주소, 소속 회사, 전화번호
						    </p>
							<br />
							<h3>* 보유 및 이용기간</h3>
							<p class="highlight3">수집된 개인정보는 회원의 탈퇴요청 시 까지 보유 이용됩니다.</p>
							<br />
							
							<h3>* 거부권 및 불이익</h3>
							<p class="dlntxt">※ 정보주체는 개인정보의 수집·이용목적에 대한 동의를 거부할 수 있으며, 동의
								거부 시 한국교통안전공단 운전자격확인 서비스 사용권한 승인이 되지 않으며, 제공하는 서비스를 이용할 수 없습니다.</p>
			...
			<div class="contBox lastBox">
				<div class="nameBox">
					<h4 class="name">개인정보 수집 및 이용 동의(선택)</h4>
				</div>
				<div class="cont">
					<div class="cont_txt">
			...
			<div class="contBox lastBox">
				<div class="nameBox">
					<h4 class="name">기타 고지 사항</h4>
				</div>
				<div class="cont">
					<div class="cont_txt2">
						<div class="txt" id="txtForuser3">
							<h3>「개인정보 보호법」 제15조제1항제3호에 따라 정보주체의 동의 없이 개인정보를 수집·이용합니다.</h3>
							<p class="dlntxt">- 수집·이용 목적: 운전자격확인 관리</p>
							<p class="dlntxt">- 수집하는 개인정보 항목: (필수)운전면허번호, (선택)면허성명, 면허종별</p>
							<p class="dlntxt">- 보유기간: 1년</p>
							<p class="dlntxt">수집근거: 「개인정보 보호법」 제15조제1항제3호,「여객자동차 운수사업법」 제34조의3제1항, 같은 법 시행령 제98조제3항제9의2호 및 제45조의2</p>
						</div>
					</div>
				</div>
			</div>
