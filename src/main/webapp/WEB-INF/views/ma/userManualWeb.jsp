...
<script src="${contextPath}/js/ma/userManual.js"></script>
		...
		<div class="wrap">
			<div class="titBox">
				<div class="tit01">
					...
					<h2><c:out value='${tableName}'/>(Web)</h2>
				</div>
				<ul class="tit02">
					<li class="home"><img
				...
				<div>
					<div>
						<ul class="horizontal-list2">
							...
							<li>
								<button href="javascript:void(0)" id="moveMobile"
									style="font-size: medium; width:135px;" class="Move_btn">모바일 이용안내</button>
							</li>
						</ul>
							...
							<div class="swiper">
								...
								<div class="swiper-wrapper">
									...
									<div class="swiper-slide">
										<img src="${contextPath}/images/manualWeb/0001.jpg"
											alt="서비스이용안내(web)" width="100%">
									</div>
									<div class="swiper-slide">
										<img src="${contextPath}/images/manualWeb/0002.jpg"
											alt="서비스이용안내(web)" width="100%">
									</div>
									<div class="swiper-slide">
										<img src="${contextPath}/images/manualWeb/0003.jpg"
											alt="서비스이용안내(web)" width="100%">
									</div>
									<div class="swiper-slide">
										<img src="${contextPath}/images/manualWeb/0004.jpg"
											alt="서비스이용안내(web)" width="100%">
									</div>
									<div class="swiper-slide">
										<img src="${contextPath}/images/manualWeb/0005.jpg"
											alt="서비스이용안내(web)" width="100%">
									</div>
									<div class="swiper-slide">
										<img src="${contextPath}/images/manualWeb/0006.jpg"
											alt="서비스이용안내(web)" width="100%">
									</div>
									<div class="swiper-slide">
										<img src="${contextPath}/images/manualWeb/0007.jpg"
											alt="서비스이용안내(web)" width="100%">
									</div>
									<div class="swiper-slide">
										<img src="${contextPath}/images/manualWeb/0008.jpg"
											alt="서비스이용안내(web)" width="100%">
									</div>
									<div class="swiper-slide">
										<img src="${contextPath}/images/manualWeb/0009.jpg"
											alt="서비스이용안내(web)" width="100%">
									</div>
									<div class="swiper-slide">
										<img src="${contextPath}/images/manualWeb/0010.jpg"
											alt="서비스이용안내(web)" width="100%">
									</div>
									<div class="swiper-slide">
										<img src="${contextPath}/images/manualWeb/0011.jpg"
											alt="서비스이용안내(web)" width="100%">
									</div>
									<div class="swiper-slide">
										<img src="${contextPath}/images/manualWeb/0012.jpg"
											alt="서비스이용안내(web)" width="100%">
									</div>
									<div class="swiper-slide">
										<img src="${contextPath}/images/manualWeb/0013.jpg"
											alt="서비스이용안내(web)" width="100%">
									</div>
									<div class="swiper-slide">
										<img src="${contextPath}/images/manualWeb/0014.jpg"
											alt="서비스이용안내(web)" width="100%">
									</div>
									<div class="swiper-slide">
										<img src="${contextPath}/images/manualWeb/0015.jpg"
											alt="서비스이용안내(web)" width="100%">
									</div>
									<div class="swiper-slide">
										<img src="${contextPath}/images/manualWeb/0016.jpg"
											alt="서비스이용안내(web)" width="100%">
									</div>
									<div class="swiper-slide">
										<img src="${contextPath}/images/manualWeb/0017.jpg"
											alt="서비스이용안내(web)" width="100%">
									</div>
									<div class="swiper-slide">
										<img src="${contextPath}/images/manualWeb/0018.jpg"
											alt="서비스이용안내(web)" width="100%">
									</div>
									<div class="swiper-slide">
										<img src="${contextPath}/images/manualWeb/0019.jpg"
											alt="서비스이용안내(web)" width="100%">
									</div>
								</div>
...
<!-- 			<div class="link_wrap" id="ForCidoWeb"> -->
<!-- 				<div> -->
<!-- 					<div> -->
<!-- 						<ul class="horizontal-list2"> -->
<!-- 							<li> -->
<!-- 								<button class="Move_btn" -->
<!-- 									id="Shortcuts02" style="font-size: medium; width:140px;"> -->
<%-- 									<img src="${contextPath}/images/sub/ico_down.png" alt="다운로드아이콘" /> --%>
<!-- 									PDF 다운로드 -->
<!-- 								</button> -->
<!-- 							</li> -->
...
<!-- 							style="list-style: none; padding: 0; display: flex; justify-content: start;"> -->
<!-- 							<li class="pdfSelect" style="width: 120px;"> -->
<!-- 								<button href="javascript:void(0)" id="tabBtn05" -->
<!-- 									style="font-size: medium; width: 90%" class="manual_btn"> -->
<!-- 									가입 및<br /> 권한 신청 -->
<!-- 								</button> -->
<!-- 							</li> -->
<!-- 							<li class="pdfSelect" style="width: 120px;"> -->
<!-- 								<button href="javascript:void(0)" id="tabBtn06" -->
<!-- 									style="font-size: medium; width: 90%" class="manual_btn"> -->
<!-- 									운전자격<br />확인 -->
<!-- 								</button> -->
<!-- 							</li> -->
<!-- 							<li class="pdfSelect" style="width: 120px;"> -->
<!-- 								<button href="javascript:void(0)" id="tabBtn07" -->
<!-- 									style="font-size: medium; width: 90%" class="manual_btn"> -->
<!-- 									대여사업<br /> 관리 -->
<!-- 								</button> -->
<!-- 							</li> -->
<!-- 							<li class="pdfSelect" style="width: 120px;"> -->
<!-- 								<button href="javascript:void(0)" id="tabBtn08" -->
<!-- 									style="font-size: medium; width: 90%" class="manual_btn">고객지원</button> -->
<!-- 							</li> -->
<!-- 							<li></li> -->
<!-- 						</ul> -->
