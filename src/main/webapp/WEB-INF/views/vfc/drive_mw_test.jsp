...
<!-- MoWeb OCR TEST Script -->
<%-- <script src= "${contextPath }/resources/sdk/ocr/ocr-sdk.1ac8e17f3e0a3f4b1356.js"></script> --%>
<%-- <script src= "${contextPath }/js/vfc/ocr-sdk-sample.js"></script> --%>
...
<!-- 																<label for="temp_co_nm">파일</label> -->
	        ...
	        <!-- MoWeb OCR TEST START -->
<!-- 	        <div id="g-btn-group"> -->
<!-- 				<button id="g-ocr-btn" type="button">Ocr Start</button> -->
<!-- 			</div> -->
	        <!-- FACE SDK REQUIRED ELEMENT -->
<!--     		<div data-alchera-face="face"></div> -->
<!-- 	        <div data-useb-ocr="face" style="display: none;"> -->
<!-- 				<div data-useb-ocr="topUI"> -->
<!-- 					<span class="top-ui-logo"> -->
<!-- 					Alchera. -->
<!-- 					<b> -->
<!-- 					<span style="color: white">wasmOCR</span> -->
<!-- 					</b> -->
<!-- 					</span> -->
<!-- 				</div> -->
...
<!-- 					<span class="bottom-ui-copyright">Powered by <b>Alchera.</b></span> -->
<!-- 				</div> -->
<!-- 			</div> -->
	        <!-- MoWeb OCR TEST END -->
	    </div>
