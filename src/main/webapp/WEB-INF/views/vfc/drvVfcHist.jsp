...
#start-timePicker01, #end-timePicker01 {width: 100px;}
.searchBsnStts1{width: 130px;height: 40px;font-size: 16px;line-height: 1.42857143;font-weight:500;text-align: center;border: 1px solid #DBE0EC;border-radius: 10px;background-color: white;}
.searchBsnStts2{width: 277px;height: 40px;font-size: 16px;line-height: 1.42857143;font-weight:500;text-align: center;border: 1px solid #DBE0EC;border-radius: 10px;background-color: white;}
...
<div class="subPage sub03">
    ...
    <div id="container">
        <div class="wrap">
            ...
            <!-- 검색조건 -->
            <div>※ 시스템 부하로 인하여 최대 1주일까지 검색이 가능합니다. 한달치의 검증건수 확인이 필요하시다면 [통계/이력] 페이지 이용을 부탁드립니다.</div>
            <br>
