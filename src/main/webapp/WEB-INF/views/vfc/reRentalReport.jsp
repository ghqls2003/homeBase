...
//서식파일 연결
OOFFile file = oof.addFile("crf.root", "%root%/crf/rerental.crf");

String rentNo = request.getParameter("rentNo");
String confCertHstryNo = request.getParameter("confCertHstryNo");
...
oof.addField ("CONF_CERT_HSTRY_NO", confCertHstryNo);
...
<script src="${contextPath}/js/vfc/rentalReport.js"></script>
