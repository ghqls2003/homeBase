	    ...
	    <div class="wrap">
	        ...
	        <div class="year_picker" style="display:none;">
				...
				<ul class="yearBox">
	            	...
	            	<li id="strMonth" style="display:none;">
	                	<label for="start-picker2">시작기간</label>
	                    <input id="start-picker2" class="date_pic" title="datepicker" aria-label="시작기간조회" />
					</li>
					<li class="bar">-</li>
	                <li id="endYear">
	                ...
	                <li id="endMonth" style="display:none;">
	                	<label for="end-picker2">종료기간</label>
	                    <input id="end-picker2" class="date_pic" title="datepicker" aria-label="종료기간조회" />
					</li>
				</ul>
	        ...
	        <div class="cont-flex">
	            ...
	            <div id="chartToggle" class="right-bx cmn-bx">
	            	<div id="contToggle1" class="contBox flex-box">
	                	<div class="nameBox">
	                    	<h4 class="name">대여사업자 영업현황 통계</h4>
						</div>
					...
					<div id="contToggle2" class="contBox flex-box">
	                	<div class="nameBox">
	                    	<h4 class="name">운영상태 비율 통계<span id="ocHeader"></span></h4>
						</div>
