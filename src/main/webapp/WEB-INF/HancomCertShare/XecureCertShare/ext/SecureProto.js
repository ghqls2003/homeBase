 ...
 */
/*
 * Error Message Type : [CertShare4PC][sendApplication][envelopeCreateKeyBlock] ErrorMsg(errorCode)
 */
Secure = (function() {
	...
	function setCipher(cipherSuite) {
		...
		try {
			...
			if(e.errorMsg)
				throw  new Error("[CertShare4PC][setCipher] ErrorMsg : " +  e.errorMsg + "(" + e.errorCode + ")" );
			else
				throw e;
		}
	}
	...
	function setAlgorithm(protocolType, cipherSuite) {
		...
		try {
			...
			throw  new Error("[CertShare4PC][setAlgorithm] ErrorMsg : " +  e.errorMsg + "(" + e.errorCode + ")" );
		}
	}
	...
	var clientHello = function(protocolType, sendFn) {
		...
		try{	
			...
			if(e.errorMsg)
				throw  new Error("[CertShare4PC][clientHello] ErrorMsg : " +  e.errorMsg + "(" + e.errorCode + ")" );
			else 
				throw  new Error("[CertShare4PC][clientHello][Native] ErrorMsg : " +  e.message);
		}
	}	
	...
	var serverHello = function(protocolType, parse, cipherSuite) {
		...
		try {
			...
			if(e.errorMsg)
				throw  new Error("[CertShare4PC][serverHello]" +e.funcCall+ "ErrorMsg : " +e.errorMsg+ "(" +e.errorCode+ ")" );
			else
				throw  new Error("[CertShare4PC][serverHello]" +e.funcCall+ "[Native] ErrorMsg : " +  e.message);
		}
	};
	...
	var keyExchange = function(sendFn, cipherSuite, certPem) {
		try {
			...
			if(e.errorMsg)
				throw  new Error("[CertShare4PC][serverHello][keyExchange] ErrorMsg : " + e.errorMsg + "(" + e.errorCode + ")" );
			else
				throw  new Error("[CertShare4PC][serverHello][keyExchange][Native] ErrorMsg : " +  e.message);
		}
	};
	...
	var finish = function(parse) {
		try {
			...
			if(e.errorMsg)
				throw  new Error("[CertShare4PC][finish] ErrorMsg : " + e.errorMsg + "(" + e.errorCode + ")" );
			else
				throw  new Error("[CertShare4PC][finish][Native] ErrorMsg : " +  e.message);
		}
	};
	...
	function sendApplication(protocolType, sid, input, cipherSuite, certPem) {	
		...
		try {
			...
			if(e.errorMsg)
				throw  new Error("[CertShare4PC][sendApplication]" +e.funcCall+ " ErrorMsg : " + e.errorMsg + "(" + e.errorCode + ")" );
			else
				throw  new Error("[CertShare4PC][sendApplication]" +e.funcCall+ "[Native] ErrorMsg : " +  e.message);
		}
		return sendMsg;
	}
	...
	function receiveApplication(protocolType, parse, cipherSuite) {
		...
		try {
			...
			if(e.errorMsg)
				throw  new Error("[CertShare4PC][receiveApplication] ErrorMsg : " + e.errorMsg + "(" + e.errorCode + ")" );
			else
				throw  new Error("[CertShare4PC][receiveApplication][Native] ErrorMsg : " +  e.message);
		}
	}	
